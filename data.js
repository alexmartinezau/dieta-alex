const V='1.0.1',$=s=>document.querySelector(s),$$=s=>[...document.querySelectorAll(s)],J=(k,d)=>JSON.parse(localStorage.getItem(k)||JSON.stringify(d)),S=(k,v)=>localStorage.setItem(k,JSON.stringify(v));
