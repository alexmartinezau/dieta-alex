const V='1.2.1',$=s=>document.querySelector(s),$$=s=>[...document.querySelectorAll(s)],J=(k,d)=>{try{const raw=localStorage.getItem(k);return raw===null?d:JSON.parse(raw)}catch{localStorage.removeItem(k);return d}},S=(k,v)=>localStorage.setItem(k,JSON.stringify(v));
